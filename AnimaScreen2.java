...
public class AnimaScreen2 implements Screen{
	...
	public AnimaScreen2(GbitsGame gg) {
		game=gg;
	}
		...
		if(game.getGravity()== Gravity.DOWN)
		{
			...
			for(int i=0;i<game.BC.getColumn();i++)
			{
				...
				case "00":
					...
					{
					game.batch.draw(game.tbitI0,i*64,(loop-1)*64);	// i think this line is causing flicker
